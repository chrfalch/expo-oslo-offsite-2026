...
function Navigation() {
  ...
  return <View style={{ flex: 1 }}>
    ...
    <Stack screenOptions={{ headerTintColor: colors.accent, headerStyle: { backgroundColor: colors.background }, headerShadowVisible: false,
      ...
      <Stack.Protected guard={!!attendee}>
        ...
        <Stack.Screen name="location/[key]" options={{ title: 'Location' }} />
