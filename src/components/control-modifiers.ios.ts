...
export function controlModifiers(label?: string, selected?: boolean, testID?: string) {
  return [controlSize('large'), ...(label ? [accessibilityElement('ignore'), accessibilityLabel(label), accessibilityAddTraits(['isButton'])] : []),
